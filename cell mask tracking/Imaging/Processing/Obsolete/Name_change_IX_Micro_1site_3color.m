...
dir='/Volumes/CAPPELL-3TB/Shared_Cappell/Cappell/20130430-MCF10A-siSkp2-stain/2013-05-03';     %'/Users/scappell/Documents/Meyer_Lab/Data/2012-07-04/32';
alldir=getSubdirectories(dir); %Creates list of all the subfolders

%% Designate Channels
channels={'CFP','YFP','mRFP1','FarRed'};  %Change this to match the correct channels used in the experiment  %e.g. {'Channel1','Channel2','Channel3'}  
...
for i=1:length(alldir);
    ...
    for j=1:length(filenames);
        ...
        %% move file
         newFileName=[row_column,'_1_',channels{str2double(channel)},'_',num2str(i+104),'.tif'];  %designates new name (eg 2_4_1_EYFP_1)
