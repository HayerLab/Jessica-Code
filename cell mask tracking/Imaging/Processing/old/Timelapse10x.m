...
projectpath='F:\';
imagepath='F:\';
experimentpath='data\160301-IXL\raw\';
...
if moviebin==1
    nucr=4;
    debrisarea=20; %MCF-10A 10xBin1: H2B:100 NLS:200
    %nucr=20;
    %debrisarea=600;
elseif moviebin==2
    nucr=4;
    debrisarea=50; %MCF-10A:100, BJ5:50 !!! Threshold-only objects larger are considered nuclei
end
...
%     real3=bgsubmasked_4(blur3,nanmask,1,compression);
    ...
    if ringcalc==1
        ...
        ring_label=getcytoring_3(nuc_label,3,real2); %10xB1:4 20xB1:4
