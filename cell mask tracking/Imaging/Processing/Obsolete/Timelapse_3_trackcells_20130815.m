...
load([datadir,'wellsss_',IFstring,shot,'.mat'],'wellsss'); %if IF, already added
fmax=size(wellsss,3);
...
badframes=find(badframes(wellidx,:)==1);
...
save([datadir,shot,'_alldata.mat'],'bestsp','best_rc','corruptlist','leaveoutlist','badframes')
