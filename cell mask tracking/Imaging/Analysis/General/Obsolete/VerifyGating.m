...
tracecolor=[.49 1 .63];
drugspike=0/framesperhr; %0831:154 0920:146
%%%%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% gate traces %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
firstframe=1; lastframe=226; %0719:216 0920:226 CycD-FKBP:208 SS0222:149
...
%signal1=nucdensity;
signal2=gatedtraces(:,xsig,5);
%signal2=gatedtraces(:,xsig,5)./nucdensity;
...
for counter=1:length(selection)
    ...
    if drugspike
        ...
        line([0 0],[ymin1 ymax1],'Color','r','linewidth',tracewidth);
    end
    %%%%% mark all mitoses %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
