...
sample = [];
%sample = [8182];           % 34 in MC that is same as 779 in FTC
...
ymin1 = 0; ymax1 = 1500; ystep1 = 100;
%ymin1 = 0; ymax1 = 500; ystep1 = 100;
ymin2 = 0; ymax2 = 1; ystep2 = 0.1;
%ymin2 = 0; ymax2 = 1000; ystep2 = 100;
historycutoff = 0.5;
screening = 1;
dotsize = 8;
...
if registry
    load([datadir,moviename,'_alldata_MC_spokes_blurfix'],'bestsp','best_rc','corruptlist','leaveoutlist','blurframes')
else
...
for f = 1:size(signal1,2)
    ...
    nucarea(tempcell,f) = bestsp{f}(tempcell,4);
...
for i = leavein
    ...
    for tt = 1:scanwidth
        ...
        nucsigdrop = [nucsigdrop,tracklengthmod(diff(nucsig(i,tracklengthmod))<-800)]; %anywhere where nucsig drops -0.3 over 7 frames
    end
