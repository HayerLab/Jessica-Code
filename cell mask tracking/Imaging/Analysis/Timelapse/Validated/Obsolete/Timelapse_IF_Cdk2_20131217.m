...
if detectrisetime
    ...
    [dummy,Cdk2start,dummy,badtraces]=getCdk2features_mother(alltraces1,allstats,minlength,relative);
...
%outliers=IFdata>(mu1+3*sig1) | IFdata<(mu1-3*sig1);
...
signals2=tracedata(samplecells,:,6)./tracedata(samplecells,:,5);
...
tracesCdk2=tracedata(:,:,6)./tracedata(:,:,5); %Sabrina:6/5. Kyuho:7/5. HeeWon:7/5.
traces2=tracesCdk2;
stats=tracestats(samplecells,:);
%%% smooth data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% calculate IF values %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
IF1=IFdata(samplecells,7); %Kyuho: pS6nuc=8, pS6ring=9.  Sabrina: p21=7
IF2=IFdata(samplecells,6);
end
