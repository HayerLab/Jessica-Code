...
%maxframe=prctile(allstats(:,3),100);
detectrisetime=1;
if detectrisetime
...
%     maxframe=prctile(tracelength,100);
...
%     minval(i)=min(smooth(alltraces(i,allstats(i,1):G1entry)));
    minval(i)=min(smooth(alltraces(i,allstats(i,1)+4:allstats(i,1)+19)));
end
%hist(minval,100);
%%% sort traces %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sorttraces=1;
...
maxframe=prctile(allstats(:,3),90);
