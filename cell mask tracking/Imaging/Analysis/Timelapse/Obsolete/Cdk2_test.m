...
% want to gather cdk2 features regardless of when the trace ends
...
[minval,risetime,riseslope,badtraces]=getCdk2exitval(sampletraces);
...
%%% gate: >10frames, positive values, min=zero, remove noise %%%%%%%%%%%%%%
