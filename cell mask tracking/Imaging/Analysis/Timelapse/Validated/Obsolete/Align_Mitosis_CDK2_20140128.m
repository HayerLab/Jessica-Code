...
if detectrisetime
    ...
    [~,Cdk2start,~,badtraces]=getCdk2features_smooth(alltracesCdk2,allstats,minlength,relative);
...
mincutoff=0.6; %minval at 20frames
maxcutoff=0.8; %maxval cutoff F20-end
...
%%% generate traces %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Cdk2inc=minval>mincutoff & maxval>maxcutoff+0.2;
Cdk2low=minval<mincutoff & maxval<maxcutoff-0.2;
...
signals=tracedata(samplecells,:,7);
...
%traces2=tracedata(:,:,7)./tracedata(:,:,5);   %HeeWon:8/6
traces2=tracedata(:,:,6);
%%% smooth data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
