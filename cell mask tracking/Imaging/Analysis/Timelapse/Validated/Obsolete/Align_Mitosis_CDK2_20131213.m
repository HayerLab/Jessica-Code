...
for i=1:numtraces
    ...
    minval(i)=alltracesCdk2(i,allstats(i,1)+minlength-1); %Sabrina uses 2hr
    maxval(i)=max(alltracesCdk2(i,allstats(i,1)+minlength-1:allstats(i,2))); %max from minlength-end
end
