...
for i=1:uniquecondnum
    ...
    samplecells=Hoechstval>250000 & Hoechstval<550000; %CDKhysteresis:250k-500k cycDp21drugpanel:250k-550k
    valuesx=Alldata(:,6);
    ...
    valuesz=valuesz(samplecells & posval);
    ...
    switch dataset
        ...
        case 'cycDp21drugpanel'
            minz=0; anchorlowz=2; midz=7; anchorhighz=10; maxz=12;
        case 'IL2mutantsYT-'
            minz=5; anchorlowz=5; midz=6.5; anchorhighz=9; maxz=9;
    end
