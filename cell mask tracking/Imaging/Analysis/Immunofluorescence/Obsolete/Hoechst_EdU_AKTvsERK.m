...
offset=[];
%%% pAKT
bmin=0;  %G1: med 3  max 7  int 16     S: med:7 max 7 sum 16    G2: med 7  max 7 sum 16
bmax=12; %G1: med 9 max 12 int 19     S: med:11 max 14 sum 20   G2: med 11 max 14 sum 21
%%% pERK
...
for i=1:condnum
    ...
    for row=rowmat
        for col=colmat
            for site=sitemat
                ...
                [Ab1Allval,Ab1G1val,Ab1Sval,Ab1G2val,Ab2Allval,Ab2G1val,Ab2Sval,Ab2G2val]=main(datadir,shot);
    ...
    scatter(values1,values2,10,colorcode(i)); axis([6 10 6.5 12]);
...
function [Ab1All,Ab1G1,Ab1S,Ab1G2,Ab2All,Ab2G1,Ab2S,Ab2G2]=main(datadir,shot)
