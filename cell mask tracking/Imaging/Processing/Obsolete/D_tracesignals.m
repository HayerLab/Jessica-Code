...
%%%%%%%%%%%% Experiment Settings %%%%%%%%
framesperhr = 5;
drugtime = 210;          %set to zero if no drug
%%%%%% User settings %%%%%%%%%%%%%%%%%%%%
...
plotsignal3 = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%ymin1 = 0; ymax1 = 1; ystep1 = 0.3;   %DHB nucleus (cells w/ cdt1)
%ymin1 = 0.3; ymax1 = 2.3; ystep1 = 0.5;   %DHB ratio (cells w/ cdt1)
ymin1 = 0.3; ymax1 = 1.8; ystep1 = 0.3;   %DHB ratio (cells w/ geminin)
%ymin1 = 50; ymax1 = 100; ystep1 = 100;
%ymin1 = 0; ymax1 = 500; ystep1 = 100;

%ymin2 = 0; ymax2 = 2.5; ystep2 = 0.05; %log(cdt1)
%ymin2 = -1; ymax2 = 1.5; ystep2 = 1;
%ymin2 = 0; ymax2 = 1; ystep2 = .1;     %nuclear signal (log(H2B))
%ymin2 = 0.4; ymax2 = 0.7; ystep2 = 0.06;   %FRET signal (log)
ymin2 = 0; ymax2 = 2; ystep2 = 0.4;   %FRET signal
%ymin2 = 100; ymax2 = 1000; ystep2 = 200;  %nuclear area
...
for i = leavein
    ...
    for tt = 1:scanwidth
        ...
        nucsigdrop = [nucsigdrop,tracklengthmod(diff(nucsig(i,tracklengthmod))<-0.12)]; %C_05_1
        %nucsigdrop = [nucsigdrop,tracklengthmod(diff(nucsig(i,tracklengthmod))<-0.10)]; %D_05_1
        %nucsigdrop = [nucsigdrop,tracklengthmod(diff(nucsig(i,tracklengthmod))<-0.21)]; %E_05_1
    end
...
for counter=1:length(tc_sel)
    ...
    if screening
        ...
        selection = enoughhistory & ~corrupted & selectedin;
