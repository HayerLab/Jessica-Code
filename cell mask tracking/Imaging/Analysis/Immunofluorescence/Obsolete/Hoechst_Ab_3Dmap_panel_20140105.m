...
%     saveas(gcf,'h:\Downloads\Fig_Colorbar.jpg');
    ...
    %probmap=makeprobmap(valuesx,valuesy,valuesz,midz);
...
set(gcf,'color','w','PaperPosition',[0 0 12 10]); %6 5 (small panel: 4 3.3)
...
for i=1:numbinx
    ...
    for j=1:numbiny
        ...
        countmap(numbiny-j+1,i)=100*samplecount/total;
...
colorsz=cmap(cmapz,:);
scatter(vbinx,vbiny,30,colorsz,'fill','square');
%imagesc(countmap);
%cmap=colormap(jet);
%cmap(1,:)=[1 1 1];
%colormap(cmap);
