...
maxcutoff=0.80; %maxval cutoff F20-end
Cdk2inc=earlyval>mincutoff & maxval>maxcutoff+0.2; %default 0.4
...
badtracespipdeg=gate_lengthrange(tracespipdeg,motherstats,minlengthmother,maxthresh,minthresh);
