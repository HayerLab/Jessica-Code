...
%%%%%% Axis Settings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ymin1=0; ymax1=2;
ymin2=0.3; ymax2=2.5; %ymax2=1000;
%%%%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%[tracedata,tracestats,motherstats,~]=gathertracedata_1(datadir,shot,motheroption,daughteroption,IFoption);
[tracedata,tracestats,~,~,IDs]=gathertracedata_3(datadir,shot,motheroption,daughteroption,IFoption);

minlengthtrace=15;
minlengthmother=0;
quiescentanalysis=0;
%%% gate CDK2 data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
nucchannel=6; cytochannel=8; %7 13
...
% minthresh=100; %threshold below which min of each trace must be %50
...
for counter=1:length(selection)
    ...
    set(gcf,'color','w');
    ysig1=smoothignorenans(traces1(i,:),1); %default 3
    if plotsignal2
