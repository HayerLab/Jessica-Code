function Timelapse_General(conditions)
        ...
        for row=rowmat
            for col=colmat
                for site=sitemat
                    ...
                    [tracedatatemp,tracestatstemp,motherstatstemp,IFdatatemp]=gathertracedata_2(conditions{c,5},shot,motheroption,daughteroption,IFoption,numframes);
...
%plottraces_1(aligneddata,alignedtime,xstring,ystring,[ymin ymax],tracesmoothoption); %plot traces without categorization
plottraces_1(aligneddata(Cdk2inc,:),alignedtime,xstring,ystring,[ymin ymax],tracesmoothoption); %just Cdk2inc cells
