...
rawdir='H:\180613_IXM\180613\'; % Place where the new files will be

[rowstring,colstring,sitestring]=wellnum2strRCS_2(row,col,site); %convert integers to A_01_1 format
shot=[num2str(row),'_', num2str(col), '_', num2str(site)];

camdir='H:\180613_IXM\180613\2018-06-13\1693'; % files where the old files are
...
for time=times
    ...
    w1old=char(filenames(boolRegExp(filenames,['_',rowstring,colstring]))); %for when only one channel is captured
