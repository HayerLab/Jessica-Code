...
drugspike=10;
minlengthdaughter=30; %CDK2fatecall-minimum=15 Geminin-minimum=10
minlengthmother=1;
framesperhr=5;
    ...
    for row=rowmat
        for col=colmat
            for site=sitemat
                ...
                [tracedatatemp,daughterstatstemp,motherstatstemp,IFdatatemp]=getdatadaughtermother(datadir,shot,IFoption);
...
%[sortedidx,sortedPOI,realidx,realPOI]=GetPointsOfInterest_test('Geminin',traces2,daughterstats,minlengthdaughter,alignoption);
