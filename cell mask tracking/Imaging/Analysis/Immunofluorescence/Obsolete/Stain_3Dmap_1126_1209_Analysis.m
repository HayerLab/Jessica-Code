...
for i=1:condnum
    ...
    if dataset==20131126
        minz=4; anchorlowz=4.5; midz=5.6; anchorhighz=6.5; maxz=7; %serumrelease 20131126 Goat780
        %minz=4; anchorlowz=4.5; midz=5.5; anchorhighz=6.5; maxz=7; %serumrelease 20131126 Goat807/811
    elseif dataset==20131209
        minz=5; anchorlowz=5; midz=6.25; anchorhighz=7.5; maxz=7.5; %previously tried 6
    end
    ...
    if dataset==20131126
        %hold on; line([0 12],[13 0],'linewidth',2,'color','r');  %20131126
        axis([4 9 3 9]); %20131126 Default:[4 9 3 9] NEDDi:[4.5 9.5 3.5 11.5];
        %axis([4.5 9.5 3 9]); %hr5 presentation
    elseif dataset==20131209
        hold on; line([5.75 8.75],[15 1],'linewidth',2,'color','r'); %20131209
        axis([5 10 4 12]); %20131209
        %axis([5 10 5 12]); %hr10 presentation
    end
...
Ab1val=IFdata(:,9); %perc10nucr10:6 org5 med5 mean9 max13
Ab1val(Ab1val<1)=1; Ab1val=log2(Ab1val);
%Ab2val=IFdata(:,6)-IFdata(:,15);
Ab2val=IFdata(:,10); %p10n10:7 org6 med6 mean10 max14
