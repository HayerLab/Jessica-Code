...
if separatedirectories==1
    ...
    rawdir=[imagepath,experimentpath,shot,filesep, shot,'_']; %AH
...
if moviebin==1
    nucr=20;
    debrisarea=1200; %MCF-10A 10xBin1: H2B:100 NLS:200 !!! Threshold-only objects larger are considered nuclei
    %nucr=20;
    %debrisarea=600;
elseif moviebin==2
    nucr=6;
