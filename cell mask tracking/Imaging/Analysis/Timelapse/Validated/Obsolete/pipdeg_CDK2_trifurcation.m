...
for i=1:numtraces
    earlyval(i)=alltracesCdk2(i,alldaughterstats(i,1)+60-1); %Sabrina uses 2hr
...
mincutoff=0.10; %val 6hrs after mitosis
latecutoff=0.60;
Cdk2inc=earlyval>mincutoff;
%Cdk2low=earlyval<mincutoff;
%figure,hist(lateval(Cdk2low),30);
Cdk2lowtransient=earlyval<mincutoff;
