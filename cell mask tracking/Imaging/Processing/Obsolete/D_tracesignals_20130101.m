...
if registry
    load([datadir,moviename,'_alldata_outlier_march'],'bestsp','best_rc','corruptlist','leaveoutlist','blurframes')
...
for i = leavein
    ...
    for tt = 1:scanwidth
        ...
        nucsigdrop = [nucsigdrop,tracklengthmod(diff(nucsig(i,tracklengthmod))<-850)]; %try out several to maximize passes
    end
