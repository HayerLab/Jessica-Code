function [tracedata,curdatatracked,tracking,nuc_label]=adaptivetrack_mod(lastgoodframe,curframe,tracedata,curdata,tracking,nuc_label,jitter,winrad,H2BvsNLS)
