...
for i = leavein
    ...
    while best_rc(temptrace,5)~=best_rc(temptrace,2)
        ...
        goodmitoses(i,m:m+mitnum-1) = mothermitoses;    %doesn't org track's birth
        m = m+mitnum;
    ...
    daughtermitoses = [daughtermitoses;birth];
...
for i = leavein
    ...
    for tt = 1:scanwidth
        ...
        nucsigdrop = [nucsigdrop,tracklengthmod(diff(nucsig(i,tracklengthmod))<-0.3)]; %try out several to maximize passes
    end
