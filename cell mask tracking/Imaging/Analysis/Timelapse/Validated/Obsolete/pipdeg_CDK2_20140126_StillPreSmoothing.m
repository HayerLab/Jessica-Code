...
relative=0;
[degstarts,degends]=getdegstartandend(alltracespipdeg,allmotherstats,minlengthmother,relative);
...
badtracespipdeg=gate_pipdeg_20140126_gatenoisy(tracespipdeg,motherstats,minlengthmother,maxthresh,minthresh);
