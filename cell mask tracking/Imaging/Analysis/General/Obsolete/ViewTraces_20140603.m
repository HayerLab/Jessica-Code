...
%%% gate traces %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
firstframe=101; lastframe=229; %0715:230 0719:216 0831:234 0905:220 0920:226 CycD-FKBP:208 SS1211:230 SS0222:149
...
signal1=gatedtraces(:,xsig,8)./gatedtraces(:,xsig,6);
