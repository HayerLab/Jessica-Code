...
[time,aligneddata]=alignmotherdaughter2(traces1,daughterstats,motherstats,alignoption,drugspike,historyoption,motherperc,daughterperc,framesperhr);
%%% plot traces %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
comparetrends(aligneddata,time,Cdk2inc,Cdk2low,xstring,ystring,ylimits);
...
makeCdk2heatmaps(datasorted,POI,time,heatmapmax,heatmapmin,markoption,alignoption,xstring,framesperhr);
