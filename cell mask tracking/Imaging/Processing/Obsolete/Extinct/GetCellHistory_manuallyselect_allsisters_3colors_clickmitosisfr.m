...
for col=[1]
    for site=[0]
        ...
        load([cwd,'Data\', movieName, '_alldata'],'bestsp','best_rc')
        numframes=208;
        framesperhr=5;
        mitogenremovalframe=90;
...
%                         nucarea(gp_rc(cc,5),:)=nucareaeachcell;
                    ...
                    %% interact with the figure to get frame of 1st S phase after black dot
                    %
        ...
        save([cwd,'Data\', movieName, '_dataForManuallySelectedCells_frameOfFirstMitosisAfterMitogenRemoval'],'angieThruTime','cdt1ThruTime', 'frameOfMitosis', 'frameOfFirstMitosisAfterMitogenRemoval', 'groupNumber')
